...
[1] AUTOMATIC DUAL-PORT WEATHER & MARITIME SEA STATE AUDIT:
  ...
  * DESTINATION PORT [Paradip Port (PPT), Odisha]:
    ...
    - Draft Clearance:[WARNING DRAFT EXCEEDED] Vessel 18.0m > Port 16.0m (Offshore Lighterage Required at Sandheads Anchor!)
...
[SUCCESS] Serialized trained model to models/navifreight_gbdt_bundle.joblib`
  ...
  const handleManualDispatch = async (customParams = null) => {
    ...
    try {
      ...
      // REAL-TIME PORT CONGESTION TELEMETRY & 4-FACTOR COMPOSITE RISK SCORE (EARLY COMPUTATION)
      ...
      // Dynamic CVaR Allocation Engine: Fully wired to NLP, Weather, AND Port Congestion Traffic Risk
      ...
      let secondarySpotHedgingDirective = "";

      if (!originProper || !destProper) {
...
[4] PSU STATUTORY TENDER & BOOKING TIMELINE:
  ...
  * Ship Booking Date:   ${test1TenderPlan.bookingDate} (L1 reverse auction & Charter Party fixed)
  * Action Advisory:     ${test1TenderPlan.tenderStrategyAdvice}
======================================================================
...
[6] PSU STATUTORY TENDER & BOOKING TIMELINE:
  ...
  * Ship Booking Date:   ${test2TenderPlan.bookingDate} (L1 reverse auction & Charter Party fixed)
  * Action Advisory:     ${test2TenderPlan.tenderStrategyAdvice}
======================================================================
...
[4] PSU STATUTORY TENDER & BOOKING TIMELINE:
  ...
  * Ship Booking Date:   ${test3TenderPlan.bookingDate} (L1 reverse auction & Charter Party fixed)
  * Action Advisory:     ${test3TenderPlan.tenderStrategyAdvice}
======================================================================
