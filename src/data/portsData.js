...
export const INDIAN_EAST_COAST_PORTS = {
  ...
  gopalpur: {
    ...
    description: 'All-weather port ideal for Panamax and geared Supramax bulk parcels; secondary relief link to SAIL Rourkela.',
    hinterlandEvacuation: {
      primaryCluster: 'SAIL Rourkela Steel Plant (South Odisha Rail Link)',
      distanceKm: 430,
